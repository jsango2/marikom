    ...
    <WrapAll>
      <Container>
        ...
        <MainLinks>
          ...
          <SingleLink href='/marikomerc-kvalitete'>{t.Linkovi.kvaliteta}</SingleLink>
        ...
        <SubLinks>
          {size.width > 770 ? (
            <>
              ...
              <Column>
                ...
                <SingleLink2 href='/proizvodi'>
                  <LinkChild onClick={() => setCategory(t.Linkovi.glavonosci)}>{t.Linkovi.glavonosci}</LinkChild>
                </SingleLink2>
                <SingleLink2 href='/proizvodi'>
                  <LinkChild style={{ cursor: 'pointer' }} onClick={() => setCategory(t.Linkovi.perlaProizvodi)}>
                    {t.Linkovi.perlaProizvodi}
                  </LinkChild>
                </SingleLink2>
                <SingleLink2 href='/proizvodi'>
                  <LinkChild style={{ cursor: 'pointer' }} onClick={() => setCategory(t.Linkovi.rakovi)}>
                    {t.Linkovi.rakovi}
                  </LinkChild>
                </SingleLink2>
                <SingleLink2 href='/proizvodi'>
                  <LinkChild style={{ cursor: 'pointer' }} onClick={() => setCategory(t.Linkovi.fileti)}>
                    {t.Linkovi.fileti}
                  </LinkChild>
                </SingleLink2>
                <SingleLink2 href='/proizvodi'>
                  <LinkChild style={{ cursor: 'pointer' }} onClick={() => setCategory(t.Linkovi.skoljkasi)}>
                    {t.Linkovi.skoljkasi}
                  </LinkChild>
                </SingleLink2>
                <SingleLink2 href='/proizvodi'>
                  <LinkChild style={{ cursor: 'pointer' }} onClick={() => setCategory(t.Linkovi.ribe)}>
                    {t.Linkovi.ribe}
                  </LinkChild>
                </SingleLink2>
            ...
            <Column>
              ...
              <SingleLink2 href='/marikomerc-kvalitete'>{t.Linkovi.kvaliteta}</SingleLink2>
              <SingleLink2 href='/karijere'>{t.Linkovi.karijere}</SingleLink2>
              <SingleLink2 href='/horeca'>{t.Linkovi.horecaSuradnja}</SingleLink2>
          ...
          {size.width > 770 && (
            <ColumnIkone>
              ...
              <Social>
                ...
                <a href='https://www.linkedin.com/company/marikomerc/' target='_blank'>
                  <Linkedin />
                </a>
                <a href='https://www.google.com/maps/@44.1751437,15.3570071,19.73z?entry=ttu' target='_blank'>
                  <Location />
                </a>
              ...
              <WrapCerts>
                ...
                <Image src='/certifikat/zivjetizdravo.svg' height={27} width={35} />
