...
export default function CookieNotice() {
  ...
  return (
    <div
      ...
      role="region"
      aria-label={isHR ? "Obavijest o kolačićima" : "Cookie notice"}
    >
      <div className="cookie-notice__inner">
        <p className="cookie-notice__text">
          ...
          <Link
            href={
              locale === "hr" ? "/politika-kolacica" : "/en/politika-kolacica"
            }
          >
            <a className="cookie-notice__link">
              {isHR ? "Saznajte više" : "Learn more"}
            </a>
          </Link>
        </p>
