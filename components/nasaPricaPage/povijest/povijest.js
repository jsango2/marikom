import { WrapAll, Container, Title, WrapEvents, DashedLine, Icon, WrapArrowLeft, WrapArrowRight } from './style.js';
...
const events = [
  {
    ...
    textEng: 'Opened Marikomerc fish market at Zadar market with a chamber capacity of 8 pallets (-18°C)',
  },
  {
    godina: '2008',
    text: 'Izgrađen logističku distributivni centar u Poličniku kapaciteta 400 paleta na -18°C režimu',
    textEng: 'Built a logistics distribution center in Poličnik with a capacity of 400 pallets at -18°C',
  },
  {
    godina: '2012',
  ...
  },
  {
    ...
    textEng: 'Start of production – established a line for processing cephalopods',
  },
  {
    godina: '2015',
  ...
  },
  {
    ...
    textEng: 'Export to markets: Spain, Slovenia, Italy, Germany, Montenegro, and New Zealand',
  },
  {
    godina: '2017',
    text: 'Potpisan ugovor o distribuciji proizvodnog programa s novozelandskim partnerom',
    textEng: 'Signed a distribution agreement for the production program with a New Zealand partner',
  },
  {
    godina: '2019',
  ...
  },
  {
    ...
    textEng: 'Launch of the Perla brand for the retail segment. Opening of the first Deli Maris fish & chips location',
  },
  {
    godina: '2021',
              ...
              data
                ...
                .map((event, index) => (
                  <Dogadjaj
                    ...
                    text={
                      locale === 'hr'
                        ? event.node.timelineNasaPovijest.opisDogadajaHrvatskiJezik
                        : event.node.timelineNasaPovijest.opisDogadajaEngleskiJezik
                    }
                  />
                ))}
          </Slider>
