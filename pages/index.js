  ...
  return (
    <Layout>
      <Head>
        ...
        />
        <meta name='twitter:image' content={locale === 'hr' ? '/naslovnaOGhr.png' : '/naslovnaOGeng.png'} />
        ...
        />
        <meta property='og:url' content={locale === 'hr' ? `"https://marikomerc.hr"` : `"https://marikomerc.hr/en"`} />
        <meta property='og:image' content={locale === 'hr' ? '/naslovnaOGhr.png' : '/naslovnaOGeng.png'} />
      </Head>
